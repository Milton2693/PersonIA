...
class explorer():
    ...
    def generate_word_cloud(self):
        ...
        mask = np.array(Image.open('media/mask.png'))
    ...
    def generate_trigramas(self, valor):
        """
    ...
    def generate_comunas(self):
        ...
        dfi.export(df_comunas, 'media/comunas.png', max_cols=2)
        with open("media/comunas.png", 'rb') as comunas_image:
    ...
    def generate_municipios(self):
        ...
        dfi.export(df_municipios, 'media/municipios.png', dpi=200, max_cols=2)
        with open("media/municipios.png", 'rb') as municipios_image:
        ...
        os.remove("media/municipios.png")
        return image_html
    ...
    def generate_subtemas(self):
        ...
        dfi.export(df_sum_tema, 'media/subtemas.png', dpi=200, max_cols=2)
        with open("media/subtemas.png", 'rb') as subtemas_image:
    ...
    def generate_temas(self):
        ...
        dfi.export(df_sum_tema, 'media/temas.png', dpi=200, max_cols=2)
        with open("media/temas.png", 'rb') as temas_image:
            temas_b64_image = base64.b64encode(temas_image.read()).decode('utf-8')
        image_html = 'data:image/png;base64,{}'.format(temas_b64_image)
        os.remove("media/temas.png")
        return image_html
    ...
    def generate_servicios(self):
        ...
        dfi.export(df_servicios, 'media/servicios.png', dpi=400, max_cols=2)
        with open("media/servicios.png", 'rb') as servicios_image:
